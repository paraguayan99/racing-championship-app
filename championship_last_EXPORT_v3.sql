...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 11 déc. 2025 à 18:48
...
--
-- Doublure de structure pour la vue `driver_stats_all_seasons`
-- (Voir ci-dessous la vue réelle)
--
DROP VIEW IF EXISTS `driver_stats_all_seasons`;
CREATE TABLE IF NOT EXISTS `driver_stats_all_seasons` (
`driver_id` int
,`nickname` varchar(100)
,`category` varchar(50)
,`total_gp` bigint
...
(164, 44, 26, 31, 1, 0.0, NULL),
(165, 44, 27, 1, 2, 0.0, NULL),
(166, 44, 1, 1, 3, 0.0, NULL),
(167, 45, 1, 1, 1, 900.0, NULL),
(168, 44, 21, 34, 10, 0.0, NULL),
(169, 44, 22, 1, 11, 0.0, 'FFF'),
(170, 44, 1, 1, NULL, 0.0, 'DNF');
