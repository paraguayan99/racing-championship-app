...
$title = "ADMIN - Suppression d'un livre";
?>

<h2>ADMIN - Suppression d'un livre</h2>
...
if (isset($_SESSION["login"]) && isset($_SESSION['token']) && $_SESSION['token_time'] > $timestamp) {
    ...
    // ligne 24 - Ajout de l'input hidden pour le token
    echo '
    <div class="alert alert-warning" role="alert">
        <p>Voulez vous supprimer <strong>' .$creation->titre .' (' .$creation->auteur .')</strong> ?</p>
