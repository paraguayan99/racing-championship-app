...
<div class="section-dashboard">
    ...
    <div class="section-header">
        ...
        <a class="nav-btn-dashboard" href="/gpstats/create">Ajouter Pole Position & Fastest Lap</a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="width-actions text-center">
                        <a class="action-btn edit" href="/gpstats/update/<?= $stat->gp_id ?>">
                            <i class="fa-solid fa-pen"></i>
                        </a>
                        <a class="action-btn delete" href="/gpstats/delete/<?= $stat->gp_id ?>">
