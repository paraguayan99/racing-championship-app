<?php $title="Team-eRacing - Dashboard Admin"; ?>
...
<div class="section-dashboard">
    ...
    <div class="section-btn-dashboard"><a class="nav-btn-dashboard" href="index.php?controller=drivers&action=index">Gérer les Pilotes</a></div>
    <br>
